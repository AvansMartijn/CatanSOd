...
public class Bank {
	...
	private void create() {
		...
		// Arrays
		DevelopmentCard[] typeCard = new DevelopmentCard[] {new Knight(), new Monopoly(), new RoadBuilding(), new YearOfPlenty(), new VictoryPoint()};
		int amountOfCards[] = new int[] {AMOUNT_OF_KNIGHTS, AMOUNT_OF_MONOPOLY, AMOUNT_OF_ROADBUILDING, AMOUNT_OF_YEAROFPLENTY, AMOUNT_OF_VICTORYPOINT};
