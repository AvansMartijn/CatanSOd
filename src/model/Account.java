...
public class Account {
	...
	/**
	 * Get the Catan game with a certain idGame.
	 * Watch out that their exist no 2 games with the same idGame, than this method is fucked. 
	 * 
	 * @param idGame the id of the game, as found in the database
	 * @return the Catan game with that id, if no such game exists returns {@code null}
	 * @since 14 May 2018
