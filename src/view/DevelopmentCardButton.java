...
public class DevelopmentCardButton extends JButton {
	...
	public DevelopmentCardButton(String filePath) { // TODO switch case for type developmentcard image so as parameter a string type
										// maybe
		setPreferredSize(new Dimension(CARD_WIDTH, CARD_HEIGHT));

		URL iconURL = this.getClass().getResource(filePath);
